/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fa57421d191c39d146430afbc0e98fee)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		OAUTH: Fetcher /* oauth */;
		EVENTS: Service /* entrypoint EventsService from events */;
		DATABASE: Service /* entrypoint DatabaseDO from db-headless-ly */;
		OBJECTS: Service /* entrypoint ObjectsService from objects-do */;
		CODE: Service /* entrypoint CodeService from code-headless-ly */;
		AGENTS: Service /* entrypoint AgentsService from agents-headless-ly */;
		PAYMENTS: Service /* entrypoint PaymentsInternal from payments-do */;
		GITHUB: Service /* entrypoint GitHubService from github-do */;
		CLOUDFLARE: Service /* entrypoint CloudflareService from cloudflare-do */;
		MCP_SERVER: Fetcher /* mcp */;
		TAIL: Fetcher /* tail */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_NAME">> {}
}
