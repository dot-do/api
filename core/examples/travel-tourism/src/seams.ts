...
const BASE = {
  ...
  projection: 'travel-tourism.org.ai', // placeholder face — 5615 apex GAP (#16); sub-vertical faces carry their own tags when they serve
  motion: 'B2A',
  pattern: '402-metered',
} as const
 ...
 * brand. Agent-referred HUMAN traffic on a developer face = a missing
 * human-counterpart brand in the cell — recorded as a counterpart-brand GAP
 * in ../projections/travel-tourism.org.ai.json (consumer demand on this row
 * is agent-intermediated B2A2C and no human-vocabulary name is held).
 */
