 ...
 * human-counterpart brand in the cell. For this cell the register names NO
 * human-vocabulary counterpart — the gap is recorded in
 * ../projections/api.holdings.json; the response is a counterpart-brand
 * proposal filed against the register row (named per #3), never
 * API-vocabulary patches on this surface.
 */
