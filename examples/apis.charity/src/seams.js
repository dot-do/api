 ...
 * rollup can read them at the substrate grain, and carry identity class ×
 * referral source — the §9.3 missing-counterpart-brand diagnostic (armed
 * here: this projection RECORDS a counterpart-brand gap) reads exactly
 * those two fields.
 *
...
import { BRAND, projection } from './projection.js'
 ...
 *  referral source. id.org.ai grain when that plane is wired. */
