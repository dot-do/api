 ...
 * invariant: route = MCP tool = suite ref = SDK functionName = rates key).
 */

const SUBSTRATE = "chemicals-materials";
const PROJECTION = "chemicals-materials-placeholder"; // GAP row — G4 brand pending
const MOTION = "B2A";
