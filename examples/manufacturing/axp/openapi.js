  ...
  PricingDocument: {
    ...
    properties: {
      ...
      rates: {
        ...
        description:
          "axp-ext/rates-g2 §2 — the operationId-keyed operation rate card, TOP-LEVEL in the Pricing Document. Additive and descriptive: `model` and `hardCeiling` keep answering Appendix A.2; every row names an operation this origin's own contract declares.",
      },
      binding: {
        type: "boolean",
        description:
