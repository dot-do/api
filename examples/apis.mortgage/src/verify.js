...
export function buildVerifyDoc(manifest) {
  ...
  return {
    ...
    name: 'Run our tests',
    description:
      'The public-contract checks for apis.mortgage. Every check is runnable by anyone, keyless, against the live origin — a claim with a published passing test is proven; anything less stays out of the copy.',
