 ...
 *  exactly these two fields (and this row's B2A2C free-rider ruling makes
 *  that diagnostic load-bearing here). id.org.ai grain when that plane is
 *  wired. */
