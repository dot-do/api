 ...
 * human-counterpart brand in the cell. This row has NO human-vocabulary
 * counterpart name on record (bids.contractors is a gov-procurement door, a
 * different motion) — the counterpart-brand GAP is recorded in
 * ../projections/apis.construction.json, per spec §5.1 B2A2B rule.
 */
