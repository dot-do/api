 ...
 * (spec/apis-ax-axp-2.6.0.spec.json, vendored via git show from the
 * axp.org.ai repo's committed HEAD — see axp/VENDORED.json); the digest
 * below is the ratification digest — drifted bytes refuse before a single
 * probe fires. The hosted api.qa runs the SAME digest-locked requirement
 * implementations, so this gate green and a hosted verdict cannot diverge by
 * construction. Probes dispatch to the worker IN MEMORY at the canonical
 * placeholder origin.
 */
