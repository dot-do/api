...
| 16 | Face registered in the rail ledger | ✅ **door A** — row in `packages/rail-ledger/registry/faces.json` (ax repo, `draft/rail-ledger-v1`); `railLedger: https://ledger.apis.ax/faces?face=apis.salon` in the projection config |
