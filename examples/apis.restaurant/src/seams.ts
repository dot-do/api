 ...
 * human-counterpart brand in the cell. This row's ICP includes non-technical
 * principals (owner-operators, catering directors); the held artifact door
 * parlevels.co is recorded as the counterpart-brand CANDIDATE (not asserted)
 * in ../projections/apis.restaurant.json, per spec §5.1 B2A2B rule — the
 * gigs.* doors are labor-supply, a different motion.
 */
