...
const PROJECTION = "consulting-research-placeholder"; // GAP row — G4 brand pending
const MOTION = "B2A";
...
export function emitReceipt(request, { operation }) {
  emit("receipt", { substrate: "consulting-research", projection: PROJECTION, operation, stub: true });
}
