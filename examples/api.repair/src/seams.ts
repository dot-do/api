 ...
 * brand. Agent-referred HUMAN traffic on this face = the missing
 * human-counterpart-brand signal for this cell (the gap IS recorded in
 * ../projections/api.repair.json — the row holds no human-vocabulary name).
 */
