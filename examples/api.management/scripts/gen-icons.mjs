#!/usr/bin/env node
/**
 * Generate site/icons.js — every UI icon this site ships, resolved at
...
${fns.join('\n\n')}
`
writeFileSync(new URL('../site/icons.js', import.meta.url), out)
console.log(`wrote site/icons.js — ${ICONS.length} icons (lucide, build-time inlined)`)
