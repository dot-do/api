 ...
 * brand. Agent-referred HUMAN traffic on this agent-first rail = the
 * missing-counterpart-brand signal for this cell (the gap IS recorded:
 * see ../projections/api.cleaning.json `counterpartBrand`).
 */
