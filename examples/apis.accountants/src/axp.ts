/**
 * axp.ts — the machine face: the vendored axp-faces generator (0.2.0),
 * unwrapped. The four members this file once bridged site-side (pricing
 * `rates[]`, card `links.verify`, card `g2`, per-route operationIds) are
 * NATIVE generator inputs since axp-ext-rates-g2@0.1.0 (ratified 2026-08-23)
 * — declared in ./manifest.ts, validated fail-closed at `defineSiteManifest`,
 * emitted at the ruled placements by the generator itself. No hand-patched
 * documents, no overridden routes: one manifest in, the quartet out.
 */
