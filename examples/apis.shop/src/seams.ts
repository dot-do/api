 ...
 * brand. Agent-referred HUMAN traffic on this agent-facing brand = a missing
 * human-counterpart brand in the cell (the counterpart-brand gap is recorded
 * in ../projections/apis.shop.json).
 */
