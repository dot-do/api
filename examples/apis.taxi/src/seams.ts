 ...
 * human-counterpart brand in the cell. The register row holds NO
 * human-vocabulary name for consumer ride booking (B2A2C) — the gap is
 * recorded in ../projections/apis.taxi.json, and this seam is what triggers
 * the counterpart-brand proposal per spec §9.3.
 */
