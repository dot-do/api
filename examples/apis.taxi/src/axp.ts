 ...
 * unwrapped. The four estate members (pricing `rates[]`, card `links.verify`,
 * card `g2`, per-route operationIds) are NATIVE generator inputs
 * (axp-ext-rates-g2@0.2.0) — declared in ./manifest.ts, validated fail-closed
 * at `defineSiteManifest`, emitted at the ruled placements by the generator
 * itself. No hand-patched documents, no overridden routes: one manifest in,
 * the quartet out.
 */
